        ...
        <div class="main-content">
                ...
                <div class="breadcrumbs" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Biopsias Finalizadas</li>
                    </ul><!--.breadcrumb-->
                    <!-- 
            ...
            <div class="page-content" style="background: linear-gradient(rgb(207,122,120), white);">
                <div class="row-fluid">
                   ...
                   <!--      <div class="row-fluid"> -->
                            ...
                            <h2 class="header smaller lighter white" style="margin-top:40px;">Biopsias Finalizadas</h2>
                        ...
                        <br><br><br>
                            ...
                            <div class="table-responsive" style="margin-top:-30px;">
                             ...
                             <table id="listarbiopsiaCCV" class="table table-striped table-bordered table-hover dataTable dt-responsive"  cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php if (count($biocc)): ?>
                                                    <?php foreach ($biocc as $bioc): ?>
                                                        <tr>
                                                            <td><?php echo $bioc->id_biopsia; ?></td>
                                                            <td><?php echo $bioc->num_biopsia; ?></td>
                                                            <td><?php echo $bioc->fecha_ingreso; ?></td>
                                                            <td><?php echo $bioc->fecha_informe; ?></td>
                                                            <td><?php echo $bioc->medico;?></td>
                                                            <td><?php echo $bioc->muestras;?></td>
                                                            <td class="td-actions center">
                                                               <div class="action-buttons">
                                                              <?php if ($_SESSION['idperfil_anat'] == 1 or $_SESSION['idperfil_anat'] == 2): ?>
                                                                   <a  type="button" data-id="<?php echo $bioc->id_biopsia ?>"  href="#" class="red cambiarstatus"  ><i class='fa fa-retweet '></i></a>
                                                               <?php endif ?>                                                                
                                                                    <!--<a class="blue" href="index.php?page=biopsiaCCV&accion=editar&id=<?php echo $bioc->id_biopsia; ?>"><i class='icon-eye-open bigger-150'></i></a>-->
                                                                    <a class="blue" href="index.php?page=reportes&accion=infpacccv&id=<?php echo $bioc->id_biopsia; ?>" target="_blank"><i class="fa fa-print"></i></a>
