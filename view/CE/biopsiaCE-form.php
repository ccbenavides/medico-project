                                                            ...
                                                            <div class="span6"> 
                                                                ...
                                                                <div class="control-group" style="margin-right: 20px; margin-left: 20px;">
                                                                    <label class="control-label">Medico Tratante</label>
                                                                       <div class="controls">
                                                                                <input type="text" style="width:275px;" readonly ="true"   class=" form-control"
                                                                                   name="medicot" <?php if(!empty($_GET["id"])) :?> value="<?php if ($biopsiace->getMedicoT()=='OTRO' or $biopsiace->getMedicoT()=='') {
                                                                                     echo $biopsiace->getmedopc();
                                                                                   } else {
                                                                                     echo $biopsiace->getMedicoT();
                                                                                   }
                                        ...
                                        <div class="widget-main">
                                            <div class="row-fluid ">
                                              <div class="span12">
                                                   <div class="span6">
                                                      <div class="table-responsive">
                                                         <h3 class="text-primary blue">Laminas/Tacos<?php if($_SESSION['idusuario']==1 or $_SESSION['idperfil_anat']==4 or $_SESSION['idperfil_anat']==5):?>
                                                   ...
                                                   <div class="span6">
                                                      <div class="table-responsive">
                                                         <h3 class="text-primary blue">Macroscopia<?php if($_SESSION['idusuario']==1 or $_SESSION['idperfil_anat']==2 or $_SESSION['idperfil_anat']==4 or  $_SESSION['idperfil_anat']==5):?>
                                              ...
                                              <div class="table-responsive" >
                                                ...
                                                <div class="span12 text-center">
                                                  <a class="btn btn-success  blue" href="index.php?page=reportes&amp;accion=infpacce&amp;id=<?php echo $_GET['id'] ?>" target="_blank">Vista Previa</a> &nbsp;&nbsp;
                ...
                <div class="row-fluid">
                    ...
                    <form method="POST" class="form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="date" style="width:335px;margin-left:-40px;" class="form-control" id="fecha_informe" name="fecha_informe2"  max="<?php echo date("Y-m-d"); ?>">
                            </div>
                        </div>-->
