                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="td-actions center">
                                                               <div class="action-buttons">
                                                                    ...
                                                                    <a class="info" href="index.php?page=biopsiaCE&accion=actualizar&id=<?php echo $biocv->id_biopsia; ?>" ><i class="fa fa-eye "></i></a>
                                                                    <a class="blue" href="index.php?page=reportes&accion=infpacce&id=<?php echo $biocv->id_biopsia; ?>" target="_blank"><i class="fa fa-print bigger-130"></i></a>
                                                                    <?php endif?>
