...
<html>
    <head>
        ...
        <title>Lista de Biopsias IH</title>
            ...
            <div class="page-content" style="<?php echo $tema; ?>">
                <div class="row-fluid">
                   ...
                   <!--      <div class="row-fluid"> -->
                            ...
                            <h2 class="header smaller lighter white">Biopsias Finalizadas</h2>
                            <div class="span12">
                                          <div class="span10">
                                            <h5 class="text-success">Cantidad de registros <span class="badge"><?php echo count($finalih); ?></span></h5>
                                        </div>
                        ...
                        <br><br><br>
                            ...
                            <div class="table-responsive">
                             ...
                             <table id="listarbiopsiaIH"  class="table table-striped table-bordered table-hover dataTable dt-responsive"  cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php if (count($finalih)): ?>
                                                    <?php foreach ($finalih as $bio): ?>
                                                        <tr>
                                                            ...
                                                            <td class="td-actions center">
                                                               ...
                                                               <?php endif ?>                                                                
                                                                  <!--<a class="blue" href="index.php?page=biopsiaIH&accion=editar&id=<?php echo $bio->id_biopsia; ?>"><i class='icon-eye-open bigger-150'></i></a>-->
                                                                  <a class="blue" href="index.php?page=reportes&accion=infpacih&id=<?php echo $bio->id_biopsia; ?>" target="_blank"><i class="fa fa-print"></i></a>
