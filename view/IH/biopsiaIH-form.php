...
<html>
    ...
    <body>
                                                ...
                                                <?php endif?>
                                                  ...
                                                  <div class="table-responsive">
                                                    <h3 class="text-primary blue">Resultado
                                                      <a class="btn btn-info pull-right" id="btnAgregResultado" data-toggle="modal"><i class="icon-pencil icon-on-left bigger-110"></i> &nbsp;Añadir</a> 
                                                    </h3>
                                                    <table class="table table-bordered table-striped table-condensed table-hover">
                                                        <thead>
                                                            <tr>
                                                  ...
                                                  </div><!--tabla resultado general-->

                                                  <div class="table-responsive">
                                                    <h3 class="text-primary blue" >Detalle de Marcadores
                                                      <a class="btn btn-info pull-right" id="btnAgregResIH" data-toggle="modal"><i class="icon-pencil icon-on-left bigger-110"></i> &nbsp;Resultado de Marcadores</a>    
                                                    </h3>
                                                    <table class="table table-bordered table-striped table-condensed table-hover">
                                                        <thead>
                                                            <tr>
                                                  ...
                                                  <div class="span12 text-center">
                                                    <a class="btn btn-success blue" href="index.php?page=reportes&amp;accion=infpacih&amp;id=<?php echo $_GET['id'] ?>" target="_blank">Vista Previa</a>&nbsp;&nbsp;
                    ...
                    <form method="POST" class="form-horizontal">
                       ...
                       <!--<div class="control-group">
                          <label class="control-label green span2">FECHA DE INFORME</label>
                            <div class="controls">
                                <input type="date" class="form-control" id="fecha_informe2" name="fecha_informe" style="width:335px;margin-left:-70px;" max="<?php echo date("Y-m-d"); ?>">
                            </div>
                       </div>-->
                        <div class="control-group" >
       ...
       <div class="modal hide fade" id="modal-agregar-resultado" tabindex="0" role="dialog" aria-labelledby="tituloModal" aria-hidden="true" >
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="blue bigger" id="tituloModal">Resultado</h3>  
            </div>
            <div class="modal-body overflow-hidden" >
                <div class="row-fluid">
                    <div class="space-6"></div>
                    <form method="POST" class="form-horizontal">
                       ...
                       <!--<div class="control-group">
                        ...
                        <div class="control-group" >
                            <label class="control-label green span2" >RESULTADO..</label>
                              <textarea required="required" name="res_general"  cols="100" id="res_general" onkeyup="this.value=this.value.toUpperCase()" class="autosize-transition span12" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 210px;"><?php if(!empty($_GET["id"])) :?><?php echo $biopsiaih->getresgeneral(); ?><?php endif; ?></textarea>
            ...
            <div class="modal-footer">
                <button class="btn btn-small" data-dismiss="modal"><i class="icon-remove"></i> Cancelar</button>
                <button class="btn btn-small btn-primary"id="btnInsertarResultgen"> <i class="icon-ok"></i>Guardar</button>
            </div>
       </div><!--modal resultado general-->
