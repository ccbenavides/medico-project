            ...
            <div class="page-content" style="<?php echo $tema; ?>">
                <div class="row-fluid">
                   ...
                   <!--      <div class="row-fluid"> -->
                            ...
                            <h2 class="header smaller lighter white" style="margin-top:40px;">Muestras Asignadas</h2>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="td-actions center">
                                                               <div class="action-buttons">
                                                                    ...
                                                                    <a class="info" href="index.php?page=biopsiaIH&accion=actualizar&id=<?php echo $bioih->id_biopsia; ?>" ><i class="fa fa-eye bigger-130"></i></a>
                                                                    <a class="blue" href="index.php?page=reportes&accion=infpacih&id=<?php echo $bioih->id_biopsia; ?>" target="_blank"><i class="fa fa-print bigger-130"></i></a>
                                                                    <?php endif?>
