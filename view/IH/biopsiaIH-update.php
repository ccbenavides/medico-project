                                        ...
                                        <widget class="main">
                                            <div class="row-fluid ">
                                                <div class="space-18"></div>
                                                    ...
                                                    <form class="form-horizontal"  action="index.php?page=biopsia&accion=modificarih<?php if(!empty($_GET["id"])) :?>&id=<?php echo $_GET["id"]; endif; ?>" method="POST" enctype="multipart/form-data">
                                                       <div class="span12 ">
                                                           <div class="span6">
                                                            ...
                                                            <div class="span6">
                                                               ...
                                                               <div class="control-group" id="ltecs" style="margin-right:20px; margin-left:20px;">
                                                                ...
                                                                <div class="control-group" style="margin-right: 20px; margin-left: 20px;">
                                                                 ...
                                                                 <div class="control-group" id="divmuestra2" hidden style="margin-right:20px; margin-left:20px;margin-top:25px;" >
                                                      ...
                                                      <div id="botones" class="span12 text-center">
                                                            ...
                                                            <a href="index.php?page=biopsiaIH&accion=listar" class="btn btn-danger"><i class="fa-times-circle icon-on-left bigger-130"></i>Cancelar</a>
