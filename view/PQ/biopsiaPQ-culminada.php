                             ...
                             <table id="listarbiopsiaPQ"  class="table table-striped table-bordered table-hover dataTable dt-responsive"  cellspacing="0" width="100%">
                                             <thead>
                                                <tr>
                                                    ...
                                                    <th data-position="right" data-intro="Este item referencia al responsable del estudio de la biopsia" data-step="5">Fecha de Informe</th>
                                                    <th data-position="left" data-intro="Este item referencia a las muestras ingresadas" data-step="6">Medico Patologo</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="td-actions center">
                                                               <div class="action-buttons">
                                                                ...
                                                                <?php endif ?>                                                                
                                                                  <!--<a class="blue" href="index.php?page=biopsiaPQ&accion=editar&id=<?php echo $bio->id_biopsia; ?>"><i class='icon-eye-open bigger-150'></i></a>-->
                                                                  <a class="blue" href="index.php?page=reportes&accion=infpac&id=<?php echo $bio->id_biopsia; ?>" target="_blank"><i class="fa fa-print"></i></a>
