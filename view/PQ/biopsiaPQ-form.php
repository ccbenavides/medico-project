                                                            ...
                                                            <div class="span6">
                                                                ...
                                                                <div class="control-group" style="margin-right: 20px; margin-left: 20px;">
                                                                    <label class="control-label">Medico Tratante</label>
                                                                       <div class="controls">
                                                                                <input type="text" style="width:275px;" readonly="true" class="form-control"
                                                                                   name="medicot" <?php if(!empty($_GET["id"])) :?> value="<?php if ($biopsiap->getMedicoT()=='OTRO') {
                                                                                       echo $biopsiap->getmedopc();
                                                                                   } else {
                                                                                       echo $biopsiap->getMedicoT();
                                                                                   }
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            <div class="row-fluid ">
                                                 ...
                                                 <div class="span12">
                                                        <div class="span6">
                                                            <div class="table-responsive">
                                                                ...
                                                                <h3 class="text-primary  blue">Laminas/Tacos<?php if($_SESSION['idusuario']==1 or $_SESSION['idperfil_anat']==4 or $_SESSION['idperfil_anat']==5):?><a data-position="right" data-intro="Para agregar el material utilizado en la biopsia, debe hacer click en el boton Laminas/Tacos." data-step="2" class="btn btn-info pull-right" id="btnAgregarMaterial" data-toggle="modal"><i class="icon-pencil icon-on-left bigger-110"></i> &nbsp;Laminas / Tacos</a><?php endif?></h3>
                                                        ...
                                                        <div class="span6" >
                                                            <div class="table-responsive" >
                                                                <h3 class="text-primary  blue">Macroscopia<?php if($_SESSION['idusuario']==1 or $_SESSION['idperfil_anat']==2 or $_SESSION['idperfil_anat']==4 or $_SESSION['idperfil_anat']==5):?><a data-position="left" data-intro="Para agregar la macroscopia, debe hacer click en el boton Macroscopia." data-step="3" class="btn btn-info pull-right" id="btnAgregarMacro" data-toggle="modal"><i class="icon-pencil icon-on-left bigger-110"></i> &nbsp;Macroscopia</a><?php endif?></h3>
                                                                <table class="table table-bordered table-striped table-condensed table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Macroscopia</th>                                                                        
                                                ...
                                                <?php if($_SESSION['idperfil_anat']==5 or $_SESSION['idperfil_anat']==4):?>
                                                ...
                                                <div class="span12 text-center">
                                                    <a type="button" class=" btn btn-success blue" href="index.php?page=reportes&amp;accion=infpac&amp;id=<?php echo $_GET['id']; ?>" target="_blank"><b>Vista Previa</b></a>                                                &nbsp;&nbsp;                                  
                    ...
                    <form method="POST" class="form-horizontal">
                        ...
                        <!--<div class="control-group">
                            ...
                            <div class="controls">2
                                <input type="date" style="width:335px;margin-left:-40px;" class="form-control" id="fecha_informe2" name="fecha_informe"  max="<?php echo date("Y-m-d"); ?>">
                            </div>
                        </div>-->
