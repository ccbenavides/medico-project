            ...
            <div class="page-content">
                <div class="row-fluid">
                   ...
                   <!--      <div class="row-fluid"> -->
                            ...
                            <h2 class="header smaller lighter blue">Bitacora</h2>
                            <div class="span12">
                                          <div class="span10">
                                            <h5 class="text-success">Cantidad de registros <span class="badge"><?php echo count($bitacoras); ?></span></h5>
                                        </div>
                                                ...
                                                <?php if (count($bitacoras)): ?>
                                                    <?php foreach ($bitacoras as $registro): ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $registro->hostname; ?></td>
                                                            <td><?php echo $registro->accion; ?></td>
                                                            <td><?php echo $registro->fecha; ?></td>
                                                            <td><?php echo $registro->tabla; ?></td>
                                                            <td><?php echo $registro->nick . " accedi&oacute desde la IP " . $registro->host; ?></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                <?php else : ?>
