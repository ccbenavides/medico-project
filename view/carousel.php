<div class="container">
    ...
    <div id="myCarousel" class="carousel slide">
        <div class="carousel-inner">
            <div class="item">
                <img src="view/img/pq.jpg" alt="">
                <div class="container">

                    <div class="carousel-caption">
                        <h1 class="text-center text-primary"><b>PATOLOGIA QUIRUGICA - HOSPITAL REGIONAL LAMBAYEQUE</b></h1>

                    </div>
                </div>
            </div>
            <div class="item">
                <img src="view/img/ce.jpg" alt="">
                <div class="container">
                    <div class="carousel-caption">
                        <h1 class="text-center text-primary"><b>CITOLOGIA ESPECIAL - HOSPITAL REGIONAL LAMBAYEQUE</b></h1>
                    </div>
                </div>
            </div>
             <div class="item">
                <img src="view/img/ccv.jpg" alt="">
                <div class="container">
                    <div class="carousel-caption">
                        <h1 class="text-center text-primary"><b>CITOLOGIA CERVICO VAGINAL - HOSPITAL REGIONAL LAMBAYEQUE</b></h1>
                    </div>
                </div>
            </div>
            <div class="item active">
                <img src="view/img/ih.jpg" alt="">
                <div class="container">
                    <div class="carousel-caption">
                        <h1 class="text-center text-primary"><b>INMUNOHISTOQUIMICA - HOSPITAL REGIONAL LAMBAYEQUE</b></h1>
<!--                            <p class="lead">.</p>-->
