...
if ($fecha1!=$fecha2) {
	...
	$pdf->Cell(0,5,"ESTADISTICAS DE PROCEDENCIA DE BIOPSIAS DEL ".$fecha1_dia."-".$fecha1_mes."-".$fecha1_anio." AL ".$fecha2_dia."-".$fecha2_mes."-".$fecha2_anio,0,0,'C');
	...
	$titu="ESTADISTICAS DE PROCEDENCIA DE BIOPSIAS DEL ".$fecha1_dia."-".$fecha1_mes."-".$fecha1_anio;
}
$pdf->Ln(10);
$pdf->SetX(60);
