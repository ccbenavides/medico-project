...
class PDF extends FPDF{
	function Header()
	{
	    ...
	    $this->SetXY(40,18);
	    $this->Cell(130,1, "SERVICIO DE CITOLOGIA ESPECIAL", 0, 0, 'C');//editado
...
$pdf->Cell(0,5,"CITOLOGIA ESPECIAL (TACOS Y LAMINAS POR MEDICOS)",0,0,'C');
$titu="CITOLOGIA ESPECIAL (TACOS Y LAMINAS POR MEDICOS)";
$pdf->Ln(10);
$pdf->SetX(25);
