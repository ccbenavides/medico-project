...
class PDF extends FPDF{
	function Header()
	{
	    ...
	    $this->SetXY(40,18);
	    $this->Cell(130,1, "SERVICIO DE PATOLOGIA QUIRURGICA", 0, 0, 'C');//editado
...
$pdf->Cell(0,5,"PATOLOGIA QUIRURGICA (TACOS Y LAMINAS POR MEDICOS)",0,0,'C');
$titu="PATOLOGIA QUIRURGICA (TACOS Y LAMINAS POR MEDICOS)";
$pdf->Ln(10);
$pdf->SetX(25);
$pdf->SetFont('Arial','B',8.5);
$pdf->Cell(30,5,utf8_decode("N° LÁMINAS"),1,0,'C');
$pdf->Cell(30,5,utf8_decode("N° TACOS"),1,0,'C');
$pdf->Cell(100,5,utf8_decode("MEDICO ANATOMOPATOLOGO"),1,0,'C');
$pdf->Ln(5);
$numeros=0;
for ($i=0; $i < count($laminastacos); $i++) { 
	$pdf->SetX(25);
	$pdf->SetFont('Arial','',8.5);
	$pdf->Cell(30,5,$laminastacos[$i]->total_laminas,1,0,'C');
	$pdf->Cell(30,5,$laminastacos[$i]->total_tacos,1,0,'C');
	$pdf->Cell(100,5,$laminastacos[$i]->nombres,1,0,'C');
	$pdf->Ln(5);
}
