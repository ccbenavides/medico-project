...
class PDF extends FPDF{
	function Header()
	{
	    ...
	    $this->SetXY(40,18);
	    $this->Cell(130,1, "SERVICIO DE INMUNOHISTOQUIMICA", 0, 0, 'C');//editado
...
$pdf->Cell(0,5,"HINMUNOHISTOQUIMICA (NUMERO DE MARCADORES)",0,0,'C');
$titu="HINMUNOHISTOQUIMICA (NUMERO DE MARCADORES)";
$pdf->Ln(10);
$pdf->SetX(40);
...
$pdf->Ln(5);
$numeros=0;
for ($i=0; $i < count($nmarcadores); $i++) { 
	$pdf->SetX(40);
	$pdf->SetFont('Arial','',8.5);
	$pdf->Cell(30,5,$nmarcadores[$i]->total_marcadores,1,0,'C');
	$pdf->Cell(100,5,$nmarcadores[$i]->nombres,1,0,'C');
	$pdf->Ln(5);
}
