            ...
            <div class="main-content">
                <div class="breadcrumbs" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Libros de Anatomia Patologica</li>
                        </ul><!--.breadcrumb-->
                        <!-- 
               ...
               <div class="page-content">
                      ...
                      <div class="row-fluid">
                        <div class="span12">
                         ...
                         <h2 class="header smaller lighter blue">Registro de Libros</h2>
                             ...
                             <div class="widget-body">
                                <div class="widget-main">
                                    <div class="row-fluid">
                                        ...
                                        <form  enctype='multipart/form-data' class="form-horizontal " action="index.php?page=mantenimiento&accion=insertarlibro<?php if(!empty($_GET["id"])) :?>&id=<?php echo $_GET["id"]; endif; ?>" method="POST">
                                            <div class="span10">
                                                   <div class="control-group" style="margin-right: 20px; margin-left: 20px;">
                                                    ...
                                                    <label class="control-label">Libro</label>
                                                        <div class="ace-file-input span5">
                                                            <input type="file" id="id-input-file-2"
                                                            name="libro" <?php if(!empty($_GET["id"])) :?> required="required" value="<?php echo $empleado->getEmp_foto(); ?>" <?php endif; ?> autocomplete="off">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="span12 text-center">
                                                <button type="submit" class="btn btn-primary"> <i class="fa-floppy-o icon-on-left bigger-110"></i>Guardar</button>
                                                 <a href="index.php?page=mantenimiento&accion=libros" class="btn btn-danger"><i class="fa-times-circle icon-on-left bigger-110"></i>Cancelar</a>
