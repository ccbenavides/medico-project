            ...
            <div class="page-content">
                <div class="row-fluid">
                   ...
                   <!--      <div class="row-fluid"> -->
                            ...
                            <h2 class="header smaller lighter blue">Libros de Anatomia Patologica</h2>
                            <div class="span12">
                                          <div class="span10">
                                            <h5 class="text-success">Cantidad de registros <span class="badge"><?php echo count($lguia); ?></span></h5>
                                        </div>
                                         <div class="span2">
                                            <a class="btn btn-success" href="index.php?page=mantenimiento&accion=formlibros"><i class="fa-file-o icon-on-left bigger-110"></i>Nuevo</a>
                                        </div>
                           </div>
                        <br><br><br>
