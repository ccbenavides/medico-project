                                        ...
                                        <widget class="main">
                                            <div class="row-fluid ">
                                                <div class="space-18"></div>
                                                    ...
                                                    <form id="registropaciente" class="form-horizontal"  action="index.php?page=paciente&accion=insertar<?php if(!empty($_GET["id"])) :?>&id=<?php echo $_GET["id"]; endif; ?>" method="POST" enctype="multipart/form-data">
                                                       <div class="span12 ">
                                                           <div class="span6">
                                                      ...
                                                      <div class="span12 text-center">
                                                            ...
                                                            <a href="index.php?page=paciente&accion=listar" class="btn btn-danger"><i class="fa-times-circle icon-on-left bigger-110"></i>Cancelar</a>
