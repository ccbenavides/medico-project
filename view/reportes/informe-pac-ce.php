...
class PDF extends FPDF{
	...
	function Header()
	{
	    ...
	    $this->SetXY(25,10);	    
	    $this->Cell(100,2, "HOSPITAL REGIONAL LAMBAYEQUE", 0, 0,'C');
...
if ($cantidad>0) {
	...
	*/
	...
	for ($r=0; $r < count($biopsiasCE) ; $r++) { 
	$pdf->SetFont('Arial','B',8);
	//$patologos[]=array('',"     ".utf8_decode($biopsiasCE[$r]->patologo));
	$pdf->Cell(55,5,"",0,0,'C');
	$pdf->Cell(75,5,utf8_decode($biopsiasCE[$r]->patologo),0,0,'C');
	$pdf->Cell(65,5,"",0,0,'C');
	$pdf->Cell(75,5,utf8_decode($biopsiasCE[$r]->patologo),0,0,'C');
	}
	...
	/*
	$pdf->Ln(4);
	$pdf->tablewidths=array(70,100,43,100);
	...
	*/
	...
	$pdf->SetFont('Arial', 'B',8);
	$pdf->Cell(55,5,"",0,0,'C');
	$pdf->Cell(75,5,utf8_decode("C.M.P."." ".$biopsiasCE[$j]->emp_colegiatura).chr(32).chr(32).chr(32)."R.N.E.".' '.$biopsiasCE[$j]->emp_rne,0,0,'C');
	$pdf->Cell(65,5,"",0,0,'C');
	$pdf->Cell(75,5,utf8_decode("C.M.P."." ".$biopsiasCE[$j]->emp_colegiatura).chr(32).chr(32).chr(32)."R.N.E.".' '.$biopsiasCE[$j]->emp_rne,0,0,'C');
	$pdf->Cell(65,5,"",0,0,'C');
	}
