        ...
        <div class="main-content">
                ...
                <div class="breadcrumbs" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Tacos Pendientes</li>
                    </ul><!--.breadcrumb-->
                    <!-- 
            ...
            <div class="page-content" style="<?php echo $tema; ?>">
                <div class="row-fluid">
                   ...
                   <!--      <div class="row-fluid"> -->
                            ...
                            <h2 class="header smaller lighter blue" style="margin-top:40px;">Tacos Pendientes</h2>
